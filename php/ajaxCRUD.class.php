...
class ajaxCRUD{
	...
	*/
    ...
    function ajaxCRUDx($item, $db_table, $db_table_pk, $ajaxcrud_root = "/wp-content/plugins/bdscl-tools/php/") {
		...
		$this->bdscltools_root  = "/wp-content/plugins/bdscl-tools/";
    ...
    */
    ...
    function insertHeader($ajax_file = "ajaxCRUD.inc.php"){
		...
		if ($this->includeJQuery){
			...
			echo "<script type=\"text/javascript\" src=\"" . $this->bdscltools_root . "js/validation.js\"></script>\n";
		}
        echo "<meta http-equiv=\"content-type\" content=\"text/html; charset=UTF-8\" />\n";
        echo "<script type=\"text/javascript\" src=\"" . $this->bdscltools_root . "js/javascript_functions.js\"></script>\n";
        echo "<link href=\"" . $this->bdscltools_root . "css/" . $this->css_file . "\" rel=\"stylesheet\" type=\"text/css\" media=\"screen\" />\n";
...
class paging{
	...
	function myRecordCount($query){
		...
		if ($useMySQLi){
			$rs      			= $mysqliConn->query($query) or die(mysqli_error($query)."<br>".$query);
